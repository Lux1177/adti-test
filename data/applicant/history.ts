  ...
  uz: [
    {
      ...
      options: ["Samarqand", "Buxoro", "Kesh", "Shosh"],
      correctAnswer: "Samarqand",
    },
    {
      questionText: "XIV asrda Chig\u2018atoy xonlaridan kim birinchi bo\u2018lib o\u2018z qarorgohini Movarounnahrga ko\u2018chirgan?",
      options: ["Kebek", "Munke", "Tug\u2018luq Temur", "Abulxayrxon"],
      correctAnswer: "Kebek",
    },
    {
      questionText: "O\u2018zbekiston hududidagi qaysi manzilgohda ilk shahar alomatlari ko\u2018zga tashlanadi?",
      options: ["Jarqo\u2018ton", "Obishir", "Selengur", "Ko\u2018lbuloq"],
      correctAnswer: "Jarqo\u2018ton",
    },
    {
      questionText: "Rus podshosi Ivan IV bilan elchilik aloqalarini o\u2018rnatgan Buxoro xonini toping.",
      options: ["Abdullaxon II", "Ko\u2018chkunchixon", "Ubaydullaxon", "Imomqulixon"],
      correctAnswer: "Abdullaxon II",
    },
    {
      questionText: "Toshkent shahri kim boshchiligidagi podsho Rossiyasi qo\u2018shinlari tomonidan egallangan? (1865-yil)",
      options: ["M.Chernyayev", "M.Skobelev", "F.Romanovskiy", "fon Kaufman"],
      correctAnswer: "M.Chernyayev",
    },
    {
      questionText: "Rossiya imperiyasi tarkibidagi Turkiston general-gubernatorligi nechanchi yilda tashkil etilgan?",
      options: ["1867-yilda", "1875-yilda", "1856-yilda", "1881-yilda"],
      correctAnswer: "1867-yilda",
    },
    {
      questionText: "Sovetlar boshqaruvi davrida o\u2018zbek xotin-qizlarini ozodlikka chiqarish jarayoni qanday nom ostida o\u2018tkazilgan?",
      options: ["\u201cHujum\u201d harakati", "\u201cBosmachilik\u201d harakati", "\u201cOzodlik\u201d harakati", "\u201cKolxozchilar\u201d harakati"],
      correctAnswer: "\u201cHujum\u201d harakati",
    },
    {
      questionText: "1993-yilda O\u2018zbekiston qaysi xalqaro tashkilotga a\u2019zo bo\u2018lgan?",
      options: ["YuNESKO", "ShHT", "MDH", "BMT"],
      correctAnswer: "YuNESKO",
    },
    {
      questionText: "O\u2018zbekiston Respublikasida ijro etuvchi hokimiyat hisoblanadigan organni toping.",
      options: ["Vazirlar Mahkamasi", "Oliy Majlis", "Oliy Sud", "Konstitutsiyaviy sud"],
      correctAnswer: "Vazirlar Mahkamasi",
    },
    {
      questionText: "Qaysi daryo qadimda Yaksart deb atalgan?",
      options: ["Sirdaryo", "Amudaryo", "Zarafshon", "Qashqadaryo"],
      correctAnswer: "Sirdaryo",
    },
    {
      questionText: "XIX asrning o\u2018rtalarida Toshkent shahrining nechta darvozasi bo\u2018lgan?",
      options: ["12 ta", "9 ta", "6 ta", "14 ta"],
      correctAnswer: "12 ta",
    },
    {
      questionText: "Ikkinchi jahon urushi yillarida O\u2018zbekistonning qaysi shahrida metallurgiya zavodi bunyod etilgan?",
      options: ["Bekobod", "Qo\u2018qon", "Buxoro", "Navoiy"],
      correctAnswer: "Bekobod",
    },
    {
      questionText: "VI-VII asrlarda O\u2018rta Osiyo aholisining asosiy qismi qaysi dinga e\u2019tiqod qilgan?",
      options: ["zardushtiylik", "moniylik", "nasroniylik", "buddaviylik"],
      correctAnswer: "zardushtiylik",
    },
    {
      questionText: "XIX asr boshida qaysi hukmdorning hukmronligi davrida Qo\u2018qon adabiy muhiti shakllangan?",
      options: ["Umarxon", "Sheralixon", "Xudoyorxon", "Erdonabiy"],
      correctAnswer: "Umarxon",
    },
    {
      questionText: "Vazirlar Mahkamasining 1997-yildagi qarori bilan har ikki yilda bir marotaba qaysi shaharda \u201cSharq taronalari\u201d xalqaro musiqa festivali o\u2018tkazilib kelinmoqda?",
      options: ["Samarqand", "Buxoro", "Xiva", "Qo\u2018qon"],
      correctAnswer: "Samarqand",
    },
  ],
};
